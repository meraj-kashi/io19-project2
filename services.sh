...
ssh -o StrictHostKeyChecking=no ubuntu@$master_ip sudo gluster volume create swarm-gfs replica 3 swarm1:/gluster/brick swarm2:/gluster/brick swarm3:/gluster/brick
